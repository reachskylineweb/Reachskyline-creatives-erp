...
const ManagerDailyTodo = () => {
  ...
  // Render workload dashboard panel
  const renderWorkloadSummary = () => {
    if (workloadEmployees.length === 0) return null;

    const isSEO = false; // managerProfile.department_code === 'SEO-RS';
    const panelTitle = isSEO ? 'Specialist Workload Today' : 'Designer Workload Today';
    const activeLabel = isSEO ? 'Active Specialists' : 'Active Designers';
    ...
    return (
      <div style={{ 
        ...
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '16px' }}>
          <h2 style={{ fontSize: '15px', fontWeight: 800, color: 'var(--text-main, #0f172a)', margin: 0, display: 'flex', alignItems: 'center', gap: '8px' }}>
            <User size={16} style={{ color: 'var(--primary, #DAA71B)' }} />
            {panelTitle}
          </h2>
          <span style={{ fontSize: '12px', color: 'var(--text-muted, #64748b)' }}>
            {activeLabel}: <strong style={{ color: 'var(--text-main, #0f172a)' }}>{workloadEmployees.length}</strong>
          </span>
        </div>
            ...
            return (
              <div 
                ...
                onMouseEnter={(e) => {
                  ...
                  e.currentTarget.style.boxShadow = 'var(--shadow-md, 0 4px 6px -1px rgba(0,0,0,0.05))';
                  e.currentTarget.style.borderColor = 'var(--primary, #DAA71B)';
              ...
              >
                <div style={{ display: 'flex', alignItems: 'center', gap: '10px' }}>
                  ...
                  <div style={{ display: 'flex', flexDirection: 'column', gap: '1px' }}>
                    <span style={{ fontWeight: 700, fontSize: '12px', color: 'var(--text-main, #0f172a)' }}>
                      {emp.full_name}
                    </span>
                ...
                <div style={{
                  ...
                  alignItems: 'center',
                  justifyContent: 'center',
                  backgroundColor: count > 0 ? 'var(--primary, #DAA71B)' : 'rgba(0,0,0,0.04)',
                  color: count > 0 ? '#ffffff' : 'var(--text-muted, #64748b)',
                  fontWeight: 800,
                  fontSize: '11px',
                  minWidth: '22px',
                  height: '22px',
                  borderRadius: '11px',
                  padding: '0 6px',
                  boxShadow: count > 0 ? '0 2px 4px rgba(218, 167, 27, 0.2)' : 'none',
